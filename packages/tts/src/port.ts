// The TtsEngine PORT — the seam that decouples UI from engines. Every adapter (Web Speech, eSpeak-NG,
// sherpa-onnx-wasm, Kokoro-WebGPU) implements this; the UI depends only on it.
